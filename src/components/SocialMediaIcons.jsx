...
export const SelectSocialMediasIcons = ({name, size, ...props}) => {
  return (
    <>
      {
        name === 'X'&&
        <X width={size} height={size} {...props} />
      }
      {
        name === 'Facebook'&&
        <Facebook width={size} height={size} {...props} />
      }
      {
        name === 'Instagram'&&
        <Instagram width={size} height={size} {...props} />
      }
      {
        name === 'WhatsApp'&&
        <WhatsApp width={size} height={size} {...props} />
      }
      {
        name === 'Telegram'&&
      ...
      {
        name === 'LinkedIn'&&
        <Linkedin width={size} height={size} {...props} />
      }
      {
        name === 'TikTok'&&
        <Tiktok width={size} height={size} {...props} />
      }
      {
        name === 'YouTube'&&
      ...
      {
        name === 'Threads'&&
        <Threads width={size} height={size} {...props} />
      }
      {
        name === 'Pinterest'&&
        <Pinterest width={size} height={size} {...props} />
      } 
    </>
  )
}